...
import dev.leon.zimmermann.rpt.entity.Book as BookEntity
import dev.leon.zimmermann.rpt.generated.model.AuthorSummary
...
class BooksService(
    ...
    private fun resolveAuthors(authorIds: List<Long>?): MutableSet<dev.leon.zimmermann.rpt.entity.Author> =
